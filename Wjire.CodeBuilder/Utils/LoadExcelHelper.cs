...
namespace Wjire.CodeBuilder.Utils
{
    public class LoadExcelHelper
    {
        ...
        {
            return ExportToDataTable(_workbook.GetSheetAt(0));
        }
        ...
        {
            return ExportToDataTable(_workbook.GetSheetAt(sheetIndex - 1));
        }
        ...
        {
            return ExportToList<T>(_workbook.GetSheetAt(0), fields);
        }
